...
tim = brian.users.create!(name: "Tim Tyrell", address: "1414 Main St", city: "Denver", state: "CO", zip: 80218, email: "tim@email.com", password: "unicorn", role: 1)
...
# Items:
orange = megan.items.create!(name: 'Orange', description: "Made with sweet oranges and lemon.", price: 10, image: 'https://www.culinaryhill.com/wp-content/uploads/2019/06/culinary-hill-orange-marmalade-square-1.jpg', active: true, inventory: 5 )
strawberry = megan.items.create!(name: 'Strawberry', description: "Naturally paleo and vegan.", price: 7, image: 'https://www.texanerin.com/content/uploads/2012/06/how-to-make-strawberry-jam-2.jpg', active: true, inventory: 10 )
hippo = brian.items.create!(name: 'Hippo', description: "I'm a Hippo!", price: 50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 3 )
paper = dunder_mifflin.items.create!(name: 'Paper', description: "Premium copy paper", price: 20, image: 'https://dundermifflinpaper.com/wp-content/uploads/2013/06/20190824_185517.jpg', active: true, inventory: 50 )
...
# Discounts:
discount1 = dunder_mifflin.discounts.create!(name: "50% off 3 or more items!", item_amount: 3, discount_percentage: 50)
discount2 = dunder_mifflin.discounts.create!(name: "75% off 5 or more items!", item_amount: 5, discount_percentage: 75)
discount3 = megan.discounts.create!(name: "25% off 5 or more items!", item_amount: 5, discount_percentage: 25)
